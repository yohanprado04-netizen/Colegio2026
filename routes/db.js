...
router.get('/', authMiddleware, async (req, res) => {
  try {
    ...
    res.json({
      ...
      sals:         salones.map(s => ({ _id: String(s._id), nombre: s.nombre, ciclo: s.ciclo, jornada: s.jornada || '', mats: s.mats ?? null, colegioId: s.colegioId, colegioNombre: s.colegioNombre || '' })),
