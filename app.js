...
function initEB(){
  ...
  // ── Tabla de Equivalencia CEPA (solo para Colegio CEPA) ──────────────────
  const _esCepa = (CU.colegioNombre||'').toUpperCase().includes('CEPA');
  if(_esCepa){
    h+=`<div class="card" style="border:2px solid #3730a3;margin-top:16px">
      <div class="chd" style="background:linear-gradient(90deg,#1e1b4b,#3730a3)">
        <span class="cti" style="color:#fff">📊 Tabla de Equivalencia — Colegio CEPA</span>
      </div>
      <div class="tw">
        <table>
          <thead>
            <tr>
              <th style="background:#1e1b4b;color:#fff">Clasificación</th>
              <th style="background:#1e1b4b;color:#fff">Abreviatura</th>
              <th style="background:#1e1b4b;color:#fff">Desempeño</th>
              <th style="background:#1e1b4b;color:#fff">Escala</th>
            </tr>
          </thead>
          <tbody>
            <tr style="background:#f0fdf4">
              <td><span class="bdg" style="background:#dcfce7;color:#14532d;font-weight:800">Superior</span></td>
              <td><strong style="color:#14532d">DS</strong></td>
              <td style="font-size:12px">Creativo, innovador y puntual, en la presentación de los trabajos</td>
              <td><span class="sc scb" style="font-size:14px;font-weight:900">4.6 – 5.0</span></td>
            </tr>
            <tr style="background:#eff6ff">
              <td><span class="bdg" style="background:#dbeafe;color:#1e3a8a;font-weight:800">Alto</span></td>
              <td><strong style="color:#1e3a8a">DA</strong></td>
              <td style="font-size:12px">Alcanza los logros propuestos en las asignaturas</td>
              <td><span class="sc scg" style="font-size:14px;font-weight:900">4.0 – 4.5</span></td>
            </tr>
            <tr style="background:#fffbeb">
              <td><span class="bdg" style="background:#fef9c3;color:#78350f;font-weight:800">Básica</span></td>
              <td><strong style="color:#78350f">DB</strong></td>
              <td style="font-size:12px">Solo alcanza los niveles necesarios de logros propuestos</td>
              <td><span class="sc sco" style="font-size:14px;font-weight:900">3.5 – 3.9</span></td>
            </tr>
            <tr style="background:#fef2f2">
              <td><span class="bdg brd" style="font-weight:800">Bajo</span></td>
              <td><strong style="color:#991b1b">DI</strong></td>
              <td style="font-size:12px">No desarrolla el mínimo de las actividades curriculares requeridas</td>
              <td><span class="sc scr" style="font-size:14px;font-weight:900">0.0 – 3.4</span></td>
            </tr>
          </tbody>
        </table>
      </div>
...
function dlBoletin(estId,perFilter,anno,snapData){
  ...
  const _isCepaBol = (CU.colegioNombre||'').toUpperCase().includes('CEPA');
  const bDes = n => { n=+n; if(n===0) return '—'; if(_isCepaBol?n>=4.6:n>=4.5) return 'Superior'; if(n>=4) return 'Alto'; if(_isCepaBol?n>=3.5:n>=3) return 'Básico'; return 'Bajo'; };
  ...
  box.innerHTML=`<div style="font-family:'Arial',sans-serif;background:#fff;max-width:760px;color:#111">
    ...
    <!-- TABLA DE EQUIVALENCIA CEPA -->
    ${(CU.colegioNombre||'').toUpperCase().includes('CEPA')?`
    <div style="margin:16px 24px 0;border:1.5px solid #3730a3;border-radius:6px;overflow:hidden;page-break-inside:avoid">
      <div style="background:#1e1b4b;color:#fff;padding:7px 14px;font-size:11px;font-weight:800;letter-spacing:.04em">
        TABLA DE EQUIVALENCIA — COLEGIO CEPA
      </div>
      <table style="width:100%;border-collapse:collapse;font-size:10px">
        <thead>
          <tr style="background:#ede9fe">
            <th style="padding:5px 10px;border:1px solid #c4b5fd;text-align:left;font-weight:800;color:#3730a3">CLASIFICACIÓN</th>
            <th style="padding:5px 10px;border:1px solid #c4b5fd;text-align:center;font-weight:800;color:#3730a3">ABREVIATURA</th>
            <th style="padding:5px 10px;border:1px solid #c4b5fd;text-align:left;font-weight:800;color:#3730a3">DESEMPEÑO</th>
            <th style="padding:5px 10px;border:1px solid #c4b5fd;text-align:center;font-weight:800;color:#3730a3">ESCALA</th>
          </tr>
        </thead>
        <tbody>
          <tr style="background:#f0fdf4">
            <td style="padding:5px 10px;border:1px solid #ddd;font-weight:700;color:#14532d">Superior</td>
            <td style="padding:5px 10px;border:1px solid #ddd;text-align:center;font-weight:800;color:#14532d">DS</td>
            <td style="padding:5px 10px;border:1px solid #ddd;color:#333">Creativo, innovador y puntual, en la presentación de los trabajos</td>
            <td style="padding:5px 10px;border:1px solid #ddd;text-align:center;font-weight:900;color:#14532d">4.6 – 5.0</td>
          </tr>
          <tr style="background:#eff6ff">
            <td style="padding:5px 10px;border:1px solid #ddd;font-weight:700;color:#1e3a8a">Alto</td>
            <td style="padding:5px 10px;border:1px solid #ddd;text-align:center;font-weight:800;color:#1e3a8a">DA</td>
            <td style="padding:5px 10px;border:1px solid #ddd;color:#333">Alcanza los logros propuestos en las asignaturas</td>
            <td style="padding:5px 10px;border:1px solid #ddd;text-align:center;font-weight:900;color:#1e3a8a">4.0 – 4.5</td>
          </tr>
          <tr style="background:#fffbeb">
            <td style="padding:5px 10px;border:1px solid #ddd;font-weight:700;color:#78350f">Básica</td>
            <td style="padding:5px 10px;border:1px solid #ddd;text-align:center;font-weight:800;color:#78350f">DB</td>
            <td style="padding:5px 10px;border:1px solid #ddd;color:#333">Solo alcanza los niveles necesarios de logros propuestos</td>
            <td style="padding:5px 10px;border:1px solid #ddd;text-align:center;font-weight:900;color:#78350f">3.5 – 3.9</td>
          </tr>
          <tr style="background:#fef2f2">
            <td style="padding:5px 10px;border:1px solid #ddd;font-weight:700;color:#991b1b">Bajo</td>
            <td style="padding:5px 10px;border:1px solid #ddd;text-align:center;font-weight:800;color:#991b1b">DI</td>
            <td style="padding:5px 10px;border:1px solid #ddd;color:#333">No desarrolla el mínimo de las actividades curriculares requeridas</td>
            <td style="padding:5px 10px;border:1px solid #ddd;text-align:center;font-weight:900;color:#991b1b">0.0 – 3.4</td>
          </tr>
        </tbody>
      </table>
    </div>`:''}
